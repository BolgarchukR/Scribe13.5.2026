...
Программа все ещё требует  серьёзных доработок хотя лично я её сейчас даже активно использую и с помощью неё вот эти строки. А также выполняю наиболее распространённые команды. Но снимаю с себя всякую ответственность использование на свой страх и риск. Задумок много, но как всегда нет времени.  
